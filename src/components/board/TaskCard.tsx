    ...
    >
      {coverImageUrl && (
        <div className="relative w-full h-32 bg-zinc-900 overflow-hidden shrink-0 border-b border-white/[0.04]">
           <Image src={coverImageUrl} alt="Cover" className="w-full h-full object-cover" fill unoptimized />
           {task.project && (
      ...
      <div className={`p-3.5 relative flex-1 flex flex-col ${coverImageUrl ? 'pt-3' : ''}`}>
        ...
        {/* Project & Objective Eyebrow (Top) */}
        {(!coverImageUrl && (task.project || task.phase)) && (
          <div className="flex flex-wrap items-center gap-2 mb-2.5 w-full">
            {task.project && (
              <div 
                className="flex items-center gap-1.5 px-2 py-1 rounded-md bg-indigo-500/10 border border-indigo-500/20 text-indigo-400 text-[9px] font-bold uppercase tracking-widest truncate max-w-full shadow-sm"
            ...
            {task.phase && (
              <div 
                className="flex items-center gap-1.5 px-2 py-1 rounded-md bg-amber-500/10 border border-amber-500/20 text-amber-500 text-[9px] font-bold uppercase tracking-widest truncate max-w-full shadow-sm"
        ...
        <div className="flex items-start gap-3 w-full mb-2">
          ...
          <h4 className={`text-sm font-medium leading-relaxed transition-colors break-words flex-1 min-w-0 pr-1 ${
            isCompleted
